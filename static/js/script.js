...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (
    (heroSubtitle && window.location.pathname.endsWith("index.html")) ||
...
function createBackToTopButton() {
  ...
  backToTop.addEventListener("mouseenter", () => {
    backToTop.style.backgroundColor = "var(--accent-color)";
...
Este website foi criado por Wolfler Guzzo Ferreira.
Tecnologias utilizadas: HTML5, CSS3, JavaScript (Vanilla)

Interessado em colaborar ou tem alguma sugestão?
Entre em contato: wolfler@wolflergf.com

GitHub: https://github.com/wolflergf
LinkedIn: https://linkedin.com/in/wolflergf
`);
